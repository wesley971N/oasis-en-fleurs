...
Nos savons sont réalisés selon le procédé traditionnel de saponification à froid, qui préserve la glycérine naturelle ainsi que les propriétés des huiles végétales. Enrichis de macérâts de plantes médicinales, d'huiles essentielles et de beurres végétaux, ils nourrissent, apaisent et protègent la peau en douceur. Sans conservateur, chaque pain est façonné et découpé à la main.`,
  ...
  'Macérats oléiques': `Macérat oléique obtenu à partir d'une macération solaire de la plante fraîche, pendant 1 mois. Doux et nourrissants, ces macérats huileux sur huile d'olive biologique s'utilisent en application externe — en massage ou en soin de la peau — seuls ou comme base de baumes et de sérums. Les plantes sont récoltées dans des endroits préservés ou cultivées sans engrais chimiques ni pesticides.`,
}
...
function PageMentions({ setPage }: { setPage:(p:string)=>void }) {
  ...
  const sections = [
    ...
    { title:'6. Crédits photos', content:`Les photographies illustrant les plantes des rubriques « Huiles essentielles », « Phytembryothérapie », « Hydrolats » et « Synergies » sont des images d'illustration temporaires, en attendant les photographies des produits réels. Elles proviennent de Wikimedia Commons, demeurent la propriété de leurs auteurs et sont utilisées selon leur licence respective :

— Huiles Essentielles —
• HE Citron — André Karwath aka Aka (CC BY-SA 2.5)
• HE Poivre noir — Ragesoss (CC BY-SA 3.0)
• HE Niaouli — John Robert McPherson (CC BY-SA 4.0)
• HE Cèdre d'atlas — Wikimedia Commons (domaine public)
• HE Eucalyptus globulus — Jules Verne Times Two (CC BY-SA 4.0)
• HE Romarin officinal — Antonio from Mijas, España (CC BY-SA 2.0)
• HE Sarriette des montagnes — Sten (CC BY-SA 3.0)
• HE Serpolet — Wikimedia Commons (CC BY-SA 3.0)
• HE Encens d'Inde — Mileli (CC BY-SA 3.0)
• HE Eucalyptus citriodora — Geekstreet (CC BY-SA 4.0)
• HE Origan compact — Wilfredor (CC0)
• HE Ylang-ylang — Forest & Kim Starr (CC BY 3.0)
• HE Bois de Hô — Wikimedia Commons (CC BY 4.0)
• HE Cajeput — Carlos A. Padrón P. (CC BY-SA 4.0)
• HE Camphrier — Keisotyo (CC BY-SA 4.0)
• HE Cannelle feuille — Sten Porse (CC BY-SA 3.0)
• HE Carotte sauvage — Alvesgaspar (CC BY-SA 3.0)
• HE Cyprès — Stacey Meadwell from London, UK (CC BY 2.0)
• HE Gaulthérie couchée — Wikimedia Commons (LGPL)
• HE Genévrier — Javier martin (domaine public)
• HE Géranium rosat — Eric Hunt (CC BY-SA 2.5)
• HE Laurier noble — Didier Descouens (CC BY-SA 4.0)
• HE Lavande aspic — Jean-Luc Gorremans (CC BY-SA 2.0 fr)
• HE Lavande vraie — Hélène Rival (CC BY-SA 4.0)
• HE Marjolaine à coquille — Schlaghecken Josef (CC BY-SA 4.0)
• HE Menthe poivrée — Wikimedia Commons (CC BY 3.0)
• HE Pin sylvestre — Didier Descouens (CC BY-SA 4.0)
• HE Tea tree — Geoff Derrin (CC BY-SA 4.0)
