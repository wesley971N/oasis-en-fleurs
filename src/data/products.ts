...
export const PRODUCTS: Product[] = [
  ...
  // ── Hydrolats ─────────────────────────────────────────────────────────────
  P(56,'Hydrolat d\'hélichryse italienne','Hydrolats',10,'200ml','🌼','Anti-hématomes, favorise la résorption des bleus. Excellent pour les peaux matures et acnéiques.'),
  P(57,'Hydrolat de basilic sacré','Hydrolats',12,'200ml','🌿','Plante adaptogène : augmente la capacité de notre corps à s\'adapter au stress. Fortifie l\'immunité, soulage les problèmes digestifs.'),
  P(58,'Hydrolat de bleuet','Hydrolats',10,'200ml','💙','Action spécifique pour les yeux. Adoucissant, calme les irritations et gonflements.'),
  ...
  P(61,'Hydrolat de Cataire citronnée','Hydrolats',10,'200ml','🌿','Anti-inflammatoire, calmante, sédative. Blépharites, conjonctivites, antiviral. Calme la digestion. Aide à harmoniser la ménopause.'),
  P(155,'Hydrolat de Cataire citronnée','Hydrolats',21,'500ml','🌿','Anti-inflammatoire, calmante, sédative. Blépharites, conjonctivites, antiviral. Calme la digestion. Aide à harmoniser la ménopause.'),
  ...
  P(66,'Hydrolat de livèche','Hydrolats',10,'200ml','🌿','Digestif, antispasmodique. Diurétique, élimine l\'acide urique. Excellent anti-inflammatoire dans l\'arthrite et les rhumatismes.'),
  P(156,'Hydrolat de livèche','Hydrolats',21,'500ml','🌿','Digestif, antispasmodique. Diurétique, élimine l\'acide urique. Excellent anti-inflammatoire dans l\'arthrite et les rhumatismes.'),
  ...
  P(69,'Hydrolat de sauge officinale','Hydrolats',10,'200ml','🌿','Régénérant et antioxydant. Purifiant, équilibrant, régule la transpiration excessive. Embellisseur capillaire.'),
  P(157,'Hydrolat de sauge officinale','Hydrolats',21,'500ml','🌿','Régénérant et antioxydant. Purifiant, équilibrant, régule la transpiration excessive. Embellisseur capillaire.'),
  ...
  {...P(88,'Baume Acné','Baumes et lait corps',16,'30g','🏺','Assainit, purifie, cicatrise et hydrate profondément.'), ingredients:['Macérat de calendula','Macérat de millepertuis','Huile de nigelle bio','Hydrolat de lavande','HE de tea tree','HE de pamplemousse','HE de camomille romaine']},
  {...P(89,'Baume Acné Rosacée','Baumes et lait corps',18,'30g','🏺','Atténue les rougeurs, apaise et décongestionne.'), ingredients:['Macérat de calendula','Macérat de millepertuis','Macérat d\'hélichryse','Beurre de karité','Hydrolat de rose de Provins','HE de carotte','HE de lavande sauvage','HE de camomille romaine','HE de géranium bourbon','HE de cyprès']},
  {...P(90,'Baume Anti dermite répulsif insectes','Baumes et lait corps',24,'180g','🏺','Calme les démangeaisons, éloigne les insectes, formule cicatrisante.'), ingredients:['Macérat de calendula','Macérat de camomille','Beurre de karité','Cire d\'abeille','HE de géranium rosat','HE de lavande','HE de carotte','HE de palmarosa','HE d\'eucalyptus citriodora','HE de cajeput']},
  {...P(92,'Baume calendula','Baumes et lait corps',14,'30g','🌼','Irritations, coups de soleil, cicatrisation, régénérant.'), ingredients:['Macérat de calendula sur huile d\'olive biologique','HE de lavande vraie','Cire d\'abeille']},
  {...P(93,'Baume BomHémo','Baumes et lait corps',18,'30g','🏺','Traitement des hémorroïdes.'), ingredients:['Macérat d\'achillée millefeuille','Macérat d\'hélichryse italienne','HE de lavande','HE de carotte sauvage','HE de camomille','HE de palmarosa','HE de genévrier','Cire d\'abeille'], usage:'Application externe, 1 à 2 fois par jour.'},
  {...P(94,'Baume calendula','Baumes et lait corps',32,'100g','🌼','Baume de calendula régénérant et cicatrisant.'), ingredients:['Fleurs de calendula cultivées sans engrais chimique','Huile d\'olive biologique']},
  {...P(136,'Baume calendula','Baumes et lait corps',26,'60g','🌼','Baume de calendula régénérant et cicatrisant.'), ingredients:['Macérat de calendula sur huile d\'olive biologique','HE de lavande vraie','Cire d\'abeille']},
  {...P(95,'Baume couperose et rougeurs diffuses','Baumes et lait corps',16,'30g','🌸','Décongestionnant, calmant, adoucissant.'), ingredients:['Macérat de calendula','Macérat de camomille','Macérat d\'hélichryse','Beurre de karité','HE de cyprès','HE d\'hélichryse','HE de romarin à verbénone','HE de camomille romaine']},
  P(96,'Baume d\'hélichrysum italicum','Baumes et lait corps',14,'30g','💙','Coups, bosses, mauvaise circulation sanguine.'),
  ...
  {...P(100,'Savon au calendula et lavande vraie','Savons',6.10,'100g','🧼','Savon doux au calendula et à la lavande vraie. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Beurre de coco','Beurre de karité','Huile d\'olive','Macérat de calendula','HE de lavande vraie']},
  ...
  {...P(103,'Savon à l\'huile d\'argan et Ylang ylang','Savons',6.10,'100g','🧼','Actif sur les peaux grasses et acnéiques, anti-inflammatoire et protecteur — savon traitant, très doux. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile d\'argan','HE d\'Ylang ylang']},
  {...P(106,'Savon à l\'huile de jojoba et Ylang ylang','Savons',6.10,'100g','🧼','Savon nourrissant au jojoba et à l\'Ylang ylang. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile de jojoba','Beurre de karité','Beurre de coco','HE d\'Ylang ylang']},
  {...P(107,'Savon à l\'huile de millepertuis','Savons',6.10,'100g','🧼','Savon apaisant à l\'huile de millepertuis. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile d\'olive','Huile de millepertuis']},
  {...P(108,'Savon à l\'huile de rose musquée','Savons',6.10,'100g','🧼','Savon régénérant à la rose musquée. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Beurre de coco','Huile d\'olive biologique','Huile de rosier muscat','Feuilles de rose de Provins']},
  {...P(125,'Savon Vulcano','Savons',6.10,'100g','🧼','Savon purifiant au charbon végétal et à l\'argile rouge, parfumé au lemongrass. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile d\'olive','Beurre de karité','Huile de coco','Huile de carthame','HE de lemongrass','Argile rouge','Charbon végétal']},
  {...P(126,'Savon Carrotin','Savons',6.10,'100g','🧼','Savon bonne mine au jus de carotte, à l\'huile de noisette et à l\'argile rouge. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile d\'olive','Beurre de karité','Huile de coco','Jus de carotte','Huile de noisette','Argile rouge','HE de cèdre d\'Atlas','HE d\'orange','HE de géranium']},
  {...P(127,'Savon Douceur Miel','Savons',6.10,'100g','🧼','Savon doux et nourrissant au miel, à la cire d\'abeille et à la rose. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile d\'olive','Beurre de karité','Huile de coco','Cire d\'abeille','Miel','Poudre de rose séchée','Curcuma']},
  {...P(128,'Savon Lavandou','Savons',6.10,'100g','🧼','Savon relaxant au lavandin, délicatement teinté d\'oxyde minéral bleu. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile d\'olive','Beurre de karité','Huile de coco','HE de lavandin','Oxyde minéral bleu']},
  {...P(129,'Savon Grain de Café','Savons',6.10,'100g','🧼','Savon gommant aux grains de café, huile de jojoba, orange et thym. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile d\'olive','Beurre de karité','Huile de coco','Huile de jojoba','HE d\'orange','HE de thym','Café']},
  {...P(130,'Savon Canelange','Savons',6.10,'100g','🧼','Savon chaleureux et gourmand à la cannelle et à l\'orange. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile d\'olive','Beurre de karité','Huile de coco','Huile de sésame','HE d\'orange','HE de cannelle','Cannelle en poudre']},
  {...P(131,'Savon Menthus','Savons',6.10,'100g','🧼','Savon tonifiant et frais à la menthe, l\'eucalyptus et trois argiles. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile d\'olive','Beurre de karité','Huile de coco','HE de menthe','HE d\'eucalyptus globulus','HE de cèdre','Argile rouge','Argile verte','Argile jaune']},
  {...P(132,'Savon Patchou','Savons',6.10,'100g','🧼','Savon envoûtant au patchouli, cèdre d\'Atlas et huile de bourrache. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile d\'olive','Beurre de karité','Huile de coco','Huile de bourrache','HE de patchouli','HE de cèdre d\'Atlas','HE d\'orange','Argile blanche','Argile rouge']},
  {...P(133,'Savon à l\'huile d\'avocat','Savons',6.10,'100g','🧼','Savon nourrissant à l\'huile d\'avocat. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile d\'avocat','Beurre de coco','Beurre de karité','Huile d\'olive']},
  {...P(135,'Savon son d\'avoine & argile blanche','Savons',6.10,'100g','🧼','Savon doux et légèrement exfoliant au son d\'avoine et à l\'argile blanche. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Son d\'avoine','Argile blanche','Beurre de coco','Beurre de karité','Huile d\'olive']},
  {...P(153,'Savon Azur','Savons',6.10,'100g','🧼','Savon à l\'huile de nigelle et au beurre de coco, parfumé à la lavande vraie, au lemongrass et au géranium d\'Égypte, teinté d\'un pigment minéral bleu. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile de nigelle','Beurre de coco','HE de lavande vraie','HE de lemongrass','HE de géranium d\'Égypte','Pigment minéral bleu']},
  ...
  {...P(113,'Pelote 25 g — Mohair & Soie','Créations laines',10.6,'25 g · 125 m','🧶','Fil à tricoter artisanal 77% mohair (Super Kids) et 23% soie — pelote de 25 g / 125 m. Coloris disponibles : Naturel, Rubis, Bordeaux, Potiron, Lagon, Émeraude.'), ingredients:['77% mohair (Super Kids)','23% soie']},
  ...
  P(121,'Écharpe à pointe poitrine — Naturel','Créations laines',110,'Pièce unique','🧶','Écharpe longue en Super Kids mohair et soie, avec pointe sur la poitrine. Coloris naturel.','Fait main'),
