...
export const PRODUCTS: Product[] = [
  ...
  {...P(126,'Savon Carrotin','Savons',5,'100g','🧼','Savon bonne mine au jus de carotte, à l\'huile de noisette et à l\'argile rouge. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile d\'olive','Beurre de karité','Huile de coco','Jus de carotte','Huile de noisette','Argile rouge','HE de cèdre d\'Atlas','HE d\'orange','HE de géranium']},
  {...P(127,'Savon Douceur Miel','Savons',5,'100g','🧼','Savon doux et nourrissant au miel, à la cire d\'abeille et à la rose. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile d\'olive','Beurre de karité','Huile de coco','Cire d\'abeille','Miel','Poudre de rose séchée','Curcuma']},
  {...P(128,'Savon Lavandou','Savons',5,'100g','🧼','Savon relaxant au lavandin, délicatement teinté d\'oxyde minéral bleu. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile d\'olive','Beurre de karité','Huile de coco','HE de lavandin','Oxyde minéral bleu']},
  {...P(129,'Savon Grain de Café','Savons',5,'100g','🧼','Savon gommant aux grains de café, huile de jojoba, orange et thym. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile d\'olive','Beurre de karité','Huile de coco','Huile de jojoba','HE d\'orange','HE de thym','Café']},
  {...P(130,'Savon Canelange','Savons',5,'100g','🧼','Savon chaleureux et gourmand à la cannelle et à l\'orange. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile d\'olive','Beurre de karité','Huile de coco','Huile de sésame','HE d\'orange','HE de cannelle','Cannelle en poudre']},
  {...P(131,'Savon Menthus','Savons',5,'100g','🧼','Savon tonifiant et frais à la menthe, l\'eucalyptus et trois argiles. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile d\'olive','Beurre de karité','Huile de coco','HE de menthe','HE d\'eucalyptus globulus','HE de cèdre','Argile rouge','Argile verte','Argile jaune']},
  {...P(132,'Savon Patchou','Savons',5,'100g','🧼','Savon envoûtant au patchouli, cèdre d\'Atlas et huile de bourrache. Mille Bulles, la savonnerie artisanale des Naturels de la Source.','Mille Bulles'), ingredients:['Huile d\'olive','Beurre de karité','Huile de coco','Huile de bourrache','HE de patchouli','HE de cèdre d\'Atlas','HE d\'orange','Argile blanche','Argile rouge']},
